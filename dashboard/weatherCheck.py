...
df = pd.read_csv('https://raw.githubusercontent.com/ukfh/metoffice_datahub/main/latest_weather.csv'
                 , sep='\t'
                 , lineterminator='\n'
                 , header=None
...
# plotData = df2[[ "datetime_",  'value_h', 'value_p' ,'value_t', 'value_v', 'value_w']]
plotData = df2[[ "datetime_",'value_t']]
